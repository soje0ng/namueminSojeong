            ...
            if (urlValue !== null) {
                if (type === "number") {
                    ...
                    if (!isNaN(numValue) && isFinite(numValue)) {
                        // validValues가 있고 비어있지 않으면 허용된 값인지 확인
                        if (validValues && validValues.length > 0 && !validValues.includes(numValue)) {
                            console.warn(
                    ...
                    // validValues가 있고 비어있지 않으면 허용된 값인지 확인
                    if (validValues && validValues.length > 0 && !validValues.includes(urlValue)) {
                        console.warn(
