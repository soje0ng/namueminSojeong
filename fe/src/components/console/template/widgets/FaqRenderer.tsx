          ...
          <div className="self-stretch flex flex-col justify-start items-start w-full">
            {w.data.items.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="self-stretch inline-flex justify-start items-center gap-6 w-full cursor-pointer">
                    <div className="flex-1 inline-flex flex-col justify-center items-start gap-4">
                      <div className="inline-flex justify-start items-center gap-3 w-full">
                        <div
                          className={`w-14 h-14 rounded-[30px] flex justify-center items-center gap-2.5 shrink-0 transition-all ${isOpen ? "bg-시안-mode-Primary50" : "bg-시안-mode-Primary5 outline outline-1 outline-offset-[-1px] outline-시안-mode-Primary50"}`}
                        >
                          <div
                            className={`text-center justify-start text-3xl font-bold font-['Pretendard'] leading-10 ${isOpen ? "text-시안-mode-gray0" : "text-시안-mode-Primary50"}`}
                          >
                            Q
                          </div>
                        </div>
                        <SafeHtml
                          ...
                          className="justify-start text-zinc-950 text-2xl xl:text-3xl font-medium font-['Pretendard'] leading-tight xl:leading-10 break-keep hover:outline-dashed hover:outline-2 hover:outline-blue-400 rounded flex-1"
                      ...
                      {isOpen && item.answer && (
                        <SafeHtml
                          ...
                          className="justify-start text-시안-mode-gray50 text-base xl:text-lg font-normal font-['Pretendard'] leading-relaxed xl:leading-7 break-keep hover:outline-dashed hover:outline-2 hover:outline-blue-400 rounded w-full"
