...
export default memo(function BannerForm({
    ...
    }, [type, lang, mode, detailIdx, filesData, videoFilesData, putBannerMutation, postBannerMutation, toast, onComplete]);
    ...
    }, [detailIdx, delBannerMutation, toast, onDeleteComplete]);
