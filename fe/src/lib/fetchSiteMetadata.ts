...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || "https://basicapi.likeweb.co.kr";
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://basic.likeweb.co.kr";
